...
function CssValidator(options) {
  ...
  var req = request(w3cUrl);
  var form = req.form();
  // form.append('output', 'soap12');
  // -----------------------------9099145666399948821413800204
  // Content-Disposition: form-data; name="fragment"

  // test
  // -----------------------------9099145666399948821413800204
  // Content-Disposition: form-data; name="prefill"
  ...
  // Inline
  // -----------------------------9099145666399948821413800204
  // Content-Disposition: form-data; name="prefill_doctype"
  ...
  form.append('profile', 'css3');
  form.append('usermedium', 'all');
  form.append('type', 'none');
  form.append('warning', '1');
  form.append('vextwarning', '');
  form.append('lang', 'en');
