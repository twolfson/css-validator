...
function validateEventEmitter(options) {
  ...
  req.on('response', function (response) {
    ...
    // TODO: Find proper way to forward everything
    ['validity', 'validation-error', 'validation-warning', 'finish'].forEach(function (event) {
...
function validateCss(options, cb) {
  // Create an emitter
  var validator = validateEventEmitter(options);
